...
violations, and communicate with the teams and refbox refere. Each
...
The refbox referee has to sit at the control machine the whole time,
observe its status, announce critical situations to the field
referees, and start and stop the game on request of the field
referees. The refbox refere must also enter robot restarts and observe
the time remaining to bring back a robot, or announce if a robot may
no longer participate in the game (second restart).
...
referees. Field referees are also responsible for repositioning pucks
...
must be penalized or disentagled after a collision. Referes may
...
executing the following complaint procedure. The prodecure is also
...
cooperation with the Organizing Commitee. In this conference, the
...
Commitee (counseling). The situation shall be resolved by unanimous
