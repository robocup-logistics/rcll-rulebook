...
of \SI{30}{\milli\metre}. The transfer point(MPS+shelf) is \SI{148.165}{\milli\metre} above ground, the workpiece has to be lifted completely above this height.  \\
To help teams create own devices for manipulation and MPS mockup the following contains the exact position and dimension of the conveyor belt(Handover point is the center of the conveyor belt).\\
\begin{itemize}
\item From Bottom: \SI{375}{\milli\metre}
\item From Top: \SI{325}{\milli\metre}
\item Space between conveyor belt guides: \SI{450}{\milli\metre} diameter
