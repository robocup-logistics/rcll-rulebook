...
roam the environment and announce the detected types of their production machines to the referee
...
exploration phase.
The exploration phase ends either after four minutes or immediately after all machines have been reported by both teams.
...
\begin{enumerate}
	...
	\item When a pushing foul is detected the responsible team has to use up their restart for the stuck robot to start at the insertion zone again. The other team can decide whether or not they want to restart their robot in the insertion zone without it counting as a penalty restart.
