...
placed\footnote{This number is based on experience from the game
  ...
  this turn out to be necessary.}. These points only include the the
...
The tournament is organized in a main competition consisting of three
phases and three technical challenges. Teams can decide to participate
in any of those.

\subsection{Tournament Phases}
\label{sec:tournament-phases}
There will be three stages in the tournament, a round-robin phase for
all participating teams, playoffs for the best 4 teams from the
round-robin phase, and the finals. The best 2 teams of the playoffs
play the final game.

\paragraph{Round-Robin phase.~} 
The first stage is a group phase and will be played as a round-robin.
The teams will receive the true points they scored by delivering and
producing goods during the competition. The points will be accumulated
in this phase and the teams will be ranked according to the
accumulated points in descending order.
...
\paragraph{Finals.~}
The best 2 teams of the playoff phase will advance to the finals. The
...
Each team 10 minutes to conduct a test run with field exclusivity.
...
completed in time, the fastest time wins.
