...
develop the LLSF further towards a Smart Factory environment where
robots act as autonomous entities working in an environment with
specified, yet to some degree uncertain and dynamic, agency. xThis
...
\SI{1}{\metre}. The machine have individual application modules that
provide different functionallity. Each has a conveyor belt always
mounted at the exact same spotand a signal light. There are four kinds
of machines:
\begin{description}
