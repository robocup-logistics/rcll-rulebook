...
\begin{titlepage}
  ...
  \begin{center}
    ...
    \end{tabular}
    \vfill
    Revision Date: Wednesday, July 1\textsuperscript{\raisebox{-.2ex}{st}} 2015%DRAFT -- Work in Progress
  \end{center}
\end{titlepage}
\thispagestyle{empty}
\pagebreak
...
team scoring the first points during the extension will win. If no 
points were scored a coin toss decides.
