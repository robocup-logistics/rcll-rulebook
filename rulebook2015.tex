...
\subsubsection{Interruptions, Robot Maintenance and Machine Refill}
...
The teams will be responsible for refilling the machines (Base Elements) themselves.
Each team has to designate one team-member as a \textit{field-operator}.
This field-operator must be specified to the referee before each game. 
Only this team member will be allowed to access the field area and only in case 
of a recent refill procedure or a robot maintenance. 
The field-operator must not obstruct other robots and should interfere as little
as possible. 
...
% TODO: merge with obstruction rule!
