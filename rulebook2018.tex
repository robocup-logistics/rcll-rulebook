...
In 2018 the goal is to mark the workpieces with barcodes, to track specific
...
\emph{Stefan Brandenberger}, HFTM Technical Institute of Applied Science Mittelland, Biel, Switzerland\\[.5em]
\emph{Christian Deppe}, Festo Didactic SE, Denkendorf, Germany\\
...
the robot has to prepare the desired delivery lane (as designated by Refbox).
