...
\begin{figure}[tbh]
  ...
  \begin{tikzpicture}[scale=2.0]
    ...
    % row 1
    { M1/1/1.68/5.04/180/1, M2/2/3.92/5.04/180/1, M3/3/5.04/5.04/-90/1, 
    % row 2
      M4/1/1.68/3.92/-90/1, M5/2/2.80/3.92/90/1, R1/1/5.04/3.92/180/4,
    % row 3
      M6/4/1.68/2.80/-90/1, M7/2/3.92/2.80/180/1, M8/1/5.04/2.80/90/1, 
    % row 4
      M9/5/1.68/1.68/180/1, M10/3/2.80/1.68/0/1, M11/4/5.04/1.68/180/1, 
    % row 5
      M12/1/5.04/0.56/180/1,
    % Team 2:
    % row 5
      M13/1/1.68/6.16/180/1, M14/2/3.92/6.16/180/1, M15/3/5.04/6.16/90/1, 
    % row 6
      M16/1/1.68/7.28/90/1, M17/2/2.80/7.28/-90/1, R2/1/5.04/7.28/180/4,
    % row 7
      M18/4/1.68/8.40/90/1, M19/2/3.92/8.40/180/1, M20/1/5.04/8.40/-90/1, 
    % row 8
      M21/5/1.68/9.52/180/1, M22/3/2.80/9.52/0/1, M23/4/5.04/9.52/180/1, 
    % row 9
    ...
    \draw (2.24,3.36) [fill=none,draw=red] circle (0.225);	% TODO: new Robotino
    \draw (3.36,3.36) [fill=none,draw=red] circle (0.185);	% TODO: old Robotino
    ...
    %\node [anchor=north,rotate=90] at (0.4,2.8) {\large\sffamily Input Storage};			% TODO!!!!!!!

    %\draw [<->,red,thick,ultra thick] (3.62,3.74) -- +(0.6,0);
    %\draw [ultra thick,red] ($ (3.92,3.92) - (0.3,0.3) $) rectangle +(0.6,0.6); 		% TODO!!!!!!!
    %\node [anchor=north] at (3.92,3.6) {\sffamily Machine Space}; 						% TODO!!!!!!!

    %\node [anchor=south,rotate=90] at (5.2,2.8) {\large\sffamily Delivery Zone}; 		% TODO!!!!!!!

    %\draw [->,red,ultra thick] (2.95,0.56) -- +(0.3,0);							% TODO!!!!!!!
    %\draw [->,red,ultra thick] (3.92,1.53) -- +(0,-0.3);
    %\node [anchor=south west,text width=1cm] at (3.5,0.3)
    %{\sffamily Machine\\Facing\\Direction};

    % Name/Type explanation and arrows												% TODO!!!!!!!
...
\begin{figure}[tbh]
  ...
  \begin{tikzpicture}[scale=2.0]
    ...
    { M1/1/1.68/5.04/180/1, M2/2/3.92/5.04/180/1, M3/3/5.04/5.04/-90/1, 
    % row 2
      M4/1/1.68/3.92/-90/1, M5/2/2.80/3.92/90/1, M6/1/3.92/3.92/0/1,
    % row 3
      M7/4/1.68/2.80/-90/1, M8/2/3.92/2.80/180/1, M9/1/5.04/2.80/90/1, 
    % row 4
      M10/5/1.68/1.68/180/1, M11/3/2.80/1.68/0/1, M12/4/5.04/1.68/180/1, 
    % Team 2:
    % row 5
      M13/1/1.68/6.16/180/1, M14/2/3.92/6.16/180/1, M15/3/5.04/6.16/90/1, 
    % row 6
      M16/1/1.68/7.28/90/1, M17/2/2.80/7.28/-90/1, M18/1/3.92/7.28/0/1,
    % row 7
      M19/4/1.68/8.40/90/1, M20/2/3.92/8.40/180/1, M21/1/5.04/8.40/-90/1, 
    % row 8
      M22/5/1.68/9.52/180/1, M23/3/2.80/9.52/0/1, M24/4/5.04/9.52/180/1, 
    % recycling 1, recycling 2
      R1/R/5.45/0.15/135/0, R2/R/5.45/11.05/225/0,
    % delivery stations
      D1/D/2.45/0.2/90/2, D2/D/2.80/0.2/90/2, D3/D/3.15/0.2/90/2,		%0.26 instead of 0.2?!
      D4/D/2.45/11.0/-90/3, D5/D/2.80/11.0/-90/3, D6/D/3.15/11.0/-90/3%	%(respectively)
    }
    ...
    % R1 and R2 machine descriptions
    \node [anchor=south east,inner sep=2.5pt] at (5.2,0.0) (R1)
    {\fontsize{10pt}{10pt}\selectfont\sffamily\textbf{R1}};
    \node [anchor=north east,inner sep=2.5pt] at (5.2,11.2) (R2)
...
%    All LED flashing (at 2 Hz) & Puck is out of game after delivery
%    to (in)active gate\\%\hline
%  \end{tabularx}}
...
team will get a randomized production plan. In the playi-off and final
phases the production plan is the same for the two teams directly
competing against each other but not for the other two competing
teams. This is to avoid any potential influence on the result of prior
knowledge of the later playing teams.
\begin{figure}
\begin{floatrow}
  \capbtabbox{%
    \centering
