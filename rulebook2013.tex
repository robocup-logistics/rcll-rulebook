...
system. Partaking robots must therefore be equipped with the appropriate
markers. The goal of the challenge is to switch off as many signal units
as possible within a given time frame. Teams are ranked according to the
number of turned-off signals.
