...
\begin{table}[b!]
  ...
  \begin{tabular}{|l|c|c|c|c|c|}
    ...
    \hline
  \end{tabular}
  \caption{Machine tags are ARUCO tags with the given IDs.}
  \label{tab:markers}
\end{table}
Each machine will feature two \emph{markers} based on ARUCO AR tags,
...
documentation \refsec{sec:task} for a detailed definition
