...
area, including the ring colors assigned to the ring stations.
...
first information for each \ac{MPS} is processed,
hence per machine only one attempt can be made to report it.
