  ...
  \ffigbox{%
    ...
    \begin{minipage}{0.75\linewidth}
      \subfigure[Production of complexity $C_0$ received from a SS.]{
        ...
        \begin{minipage}{1.0\linewidth}
          \centering
          \includegraphics{products/chain_c0_SS}
        \end{minipage}
      }
      ...
      BE as shown in \reffig{fig:prod-compl-0}.]{
        ...
        \begin{minipage}{1.0\linewidth}
          \centering
          \includegraphics{products/chain_c0}
        \end{minipage}
      }
      ...
      ring according to \reffig{fig:prod-compl-1}.]{\label{fig:prod-chain-C1}%
        \begin{minipage}{1.0\linewidth}
          \centering
          \includegraphics{products/chain_c1}
        \end{minipage}
      }
    \end{minipage}
    \quad
    \subfigure[Legend]{
      ...
      \begin{minipage}{0.2\linewidth}
        \centering
        \includegraphics{products/legend}
        \vspace{2mm}
      \end{minipage}
    }
    ...
    (of any color) for the green ring.]{\label{fig:prod-chain-C2}%
      \begin{minipage}{1.0\linewidth}
        \centering
        \includegraphics{products/chain_c2}
      \end{minipage}
    }
    ...
    ring.]{\label{fig:prod-chain-C3}%
      \begin{minipage}{1.0\linewidth}
        \centering
        \includegraphics{products/chain_c3}
      \end{minipage}
    }
