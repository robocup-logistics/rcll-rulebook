...
In the \ac{RCLL}, the Robotino robotic system
from Festo Didactic SE is used as common base platform that can be used with
certain freedoms and limitations. This
...
The Robotino is the required platform for all teams participating in the main
track of the \ac{RCLL}.
...
within a cylindrical bounding box with maximum total height of \SI{1.1}{\metre}
