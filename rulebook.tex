...
Each team has the possibility for 3 maintenance actions per game for free.
3 additional maintenances can be purchased with 5 points each.
When the team has not yet received sufficient points, maintenances can be 
also purchased on (partial) credit. Missing points will be subtracted later 
from points scored. At the end, a game cannot have a negative score.

The team has to call upon the referee for \textit{robot maintenance}. The
