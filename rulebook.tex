...
twice the robot diameter, provided that the direction is within the angle
of the two outermost points of the corresponting MPS. The gripper is 
allowed to transport one workpiece at a time. And the gripper must 
release the workpiece for safety whenever the referee wants to take
out it. For example, if the referee presses the release button or key, 
