...
\begin{longtable}{p{\dimexpr.30\textwidth-2\tabcolsep}
    ...
    |p{\dimexpr.15\textwidth-2\tabcolsep}}
      ...
      %  }
        ...
        \\
        Upkeep at SS
        & A workpiece stored at time $T_s$ and retrieved at $T_r$ causes costs:
        $0-\min\{\max\{\lfloor T_r-T_s\rfloor-2, 5\}, 0\}$.
        If it is never retrieved,  $T_r$ is set to the game end.
        & $\geq -5,\leq 0$
        \\
        Total costs SS
