...
group will be composed of the teams that ranked first, third, and fifth in the
Round-Robin phase respectively. The second group contains the teams that ranked
second, fourth, and sixth. Within each group, each teams plays against all other
teams (round-robin).
