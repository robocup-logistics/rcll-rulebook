...
and team (by color) will be used. In case both teams opt-out of using markers,
no markers will be affixed to the machines.
...
\begin{table}[]
  ...
  \multicolumn{1}{l}{Field}       & \multicolumn{1}{l}{Data Type}
    & Modality \\ \hline
  \multicolumn{1}{l|}{Name}        & \multicolumn{1}{l|}{string}
      & Optional \\ \hline
  \multicolumn{1}{l|}{Type}        & \multicolumn{1}{l|}{string}
    & Required \\ \hline
  \multicolumn{1}{l|}{Zone}        & \multicolumn{1}{l|}{Zone}
    & Required \\ \hline
  \multicolumn{1}{l|}{Rotation} & \multicolumn{1}{l|}{uint32}
    & Optional \\ \hline
  \end{tabular}
...
Table~\ref{tab:scoring} for scoring). Depending on the information provided in
the report, the refbox will react the to the \textit{MachineReport} in one of
the following ways:
...
\begin{enumerate}
  ...
  \end{itemize}
  \item \textbf{Incorrect Zone or Incorrect Type: } No points will be awarded
...
\begin{longtable}{p{\dimexpr.30\textwidth-2\tabcolsep}
    ...
    |p{\dimexpr.15\textwidth-2\tabcolsep}}
          ...
          \\
          Zone
		      & Report a zone in which no machine is present.
          & $-1$
          \\
          \hline
          Round Total
