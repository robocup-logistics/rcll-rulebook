...
Corresponding machine types will be induced by the RefBox.
...
signal light encoding of machine types will be published by the refbox
...
to roam the environment and announce the detected types to the refbox.
...
The late order challenge is the derived from the former express good
rule. It will be announced at a random time by the refbox in form of a
