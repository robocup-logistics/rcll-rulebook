...
erroneous behavior of the device. Consumption of materials, such as \s0 used in
the production of \s2, will take 2 seconds. Unloading the machine can be done
...
\subtable[Optical Feedback during exploration phase]{\mytable{\begin{tabularx}{\linewidth}{p{0.35\linewidth}|X}\multicolumn{1}{l}{Optical Feedback} & \multicolumn{1}{l}{Operating mode} \\ \hline
  	    All LEDs turned off &  	Machine type will be induced by referee box. \\
	    Red LED turned on &  	Machine type will be induced by referee box. \\
        Green LED turned on &  	Machine type will be induced by referee box. \\
        Red and Green LED turned on &  	Machine type will be induced by referee box.\\
        All LEDs turned on  &  	Machine type will be induced by referee box. \\
        \hline
\end{tabularx}}}
