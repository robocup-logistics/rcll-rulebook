...
\subsection{Field sizes} \label{sec:competition-area}
...
size of (height $\times$ width $\times$ depth) \SI{280 x 160 x
  ...
  Tables~\ref{tab:production-machines}, \ref{tab:recycling-unit} and
  \ref{tab:reading-device}.
...
\begin{table}[h]
  \centering
  \subtable[Optical Feedback]{\mytable{\begin{tabularx}{\linewidth}{p{0.35\linewidth}|X}
...
challenge; the three staged production process as well as the Late
Order challenge. The main challenge can be repeated as long as enough
