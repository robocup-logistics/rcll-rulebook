...
information about the RobotinoÂ® platform and details to components
...
are obliged to use the RobotinoÂ® robotic system of Festo Didactic Gmbh
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{The Task â€“â€œA challenge of precision within a flexible
  deployment systemâ€�}
...
of three RobotinosÂ®, shall complete the following task without a
...
subassemblies step-by-step. The factoryâ€™s capacity theoretically
...
painted â€œblueâ€� marking the input store area with the express good
...
The bottom zone is marked â€œgreenâ€� and houses the three delivery gates.
...
\section{The RobotinoÂ® System}

All participants have to design their competition RobotinosÂ® within
the following specifications:

Any kind of sensors can be changed or added to the RobotinoÂ® platform.
However, it is not possible to implement sensors that require
modifications outside the RobotinoÂ® area (e.g. Northstar, indoor GPS).
It is furthermore strictly forbidden to implement any kind of RFID
device into the RobotinoÂ®. There must be no changes to the controller
...
must receive nothing else but the â€œstartâ€�, â€œpauseâ€� and â€œstopâ€� command
...
communication that requires a device other than the three RobotinosÂ® A
...
unit and the RobotinosÂ® at certain points of a match. This will not
affect the Wi-Fi connection between the RobotinosÂ® and will neither
...
RobotinosÂ® Wi-Fi unit to the access point provided. All teams can also
...
\begin{table}[h!]
  ...
  2 minutes\\[1ex]
%
  Damaging factory equipment & Theoretical damage to the â€œrealâ€�
...
%
  ...
  teamâ€™s current or next match.\\[1ex]
%
  ...
  sanctions ranged from time punishments to the teamâ€™s complete
...
On the way to fully dynamic obstacles this iteration implies a fully scripted administration controlled RobotinoÂ® that follows implicit movement rules that are known to all participants.
