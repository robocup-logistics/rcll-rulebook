...
which lasts \SI{16}{\minute}. The referee box publishes information
...
third. Two standing orders with the complexity of one $C_0$ and one
$C_1$ will be placed at the beginning of the production phase and can
be delivered any time in the game. However, just one product of this
types can be delivered for each order.  For the $C_0$ order the base
color will be red. The cap color will be randomized.  The $C_1$ order
will be completely randomized.
