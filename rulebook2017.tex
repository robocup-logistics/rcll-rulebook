...
(\reffig{fig:narrow-cone}). You can order them at festo didactic (C. Deppe)
or download the stl-file from the rcll site.
\begin{figure}
    \includegraphics[height=3.5cm]{narrowCone.jpg}
