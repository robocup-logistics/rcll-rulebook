...
of \SI{1 x 1}{\metre} with 12 randomly distributed machines. The
...
The zones and orientation are randomly determined,  and will not be 
communicated.~\refsec{sec:exploration-phase}. The random algorithm
has some constraints. Machines at edge positions are aligned exclusively 
