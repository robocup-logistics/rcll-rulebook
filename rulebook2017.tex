...
MPS Station has a well defined local (x,y)-coordinate system: The x-axis is 
given by the conveyor and the positive direction is in the direction from the 
input to the output. The origin is just the center point of the conveyor. The 
positive y-axis shows in the opposite direction of the light signal. Hence the 
...
Therefore all CS and RS which are placed next to walls (zones: C-Z*1, C-Z*8, C-Z7*, M-Z*1, M-Z*8 and M-Z7*) are rotated in a way that the y-axis is facing towards the wall they are places next to.
