...
\item[CS] The CS setup message initiates either the retrieval or the
  ...
  machine. All Base Elements prepared on the shelf are special colored
  workpieces that can only be used for preparing RS or recycling. The
  machine will take the cap off the base and buffer it, releasing the
