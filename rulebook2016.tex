...
develop the RCLL further. Smart Factory environments require new 
concepts of flexibility, awareness and optimisation from autonomous entities working in an environment with
...
plug-and-produce capable systems. Opposed to numerous approaches
regarding production infrastructure, RCLL aims to provide concepts for smart production logistics.
...
\item[CS] The CS setup message initiates either the retrieval or the
  ...
  workpieces that can only be used for providing additional bases to RS
 (see below), reuse by repositioning on the shelf or recycling at DS.
 The machine will take the cap off the base and buffer it on the slide, releasing the
